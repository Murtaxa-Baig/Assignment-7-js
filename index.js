...
function vowelCheck() {
    ...
    if (char == "a" || char == "A") {
        ...
        alert("This chracter is not vowel")
    }
}
...
function weekPrint() {
    ...
    if (num == 1) {
        ...
        alert("Enetr number between 1 to 7")
    }
}
...
function monthCheck() {
    ...
    if (num == 1) {
        ...
        alert("Enetr number between 1 to 12")
    }
}
